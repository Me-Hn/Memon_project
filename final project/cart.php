...
$grandtotal=0;
 ...
 $query="select * from addporduct where id='$Id'";	
 $dis=mysqli_query($con,$query) or die (mysqli_error());	 
 $row=mysqli_fetch_array($dis);
 $grandtotal+=$row['new']*$value; 
?>	 
	 
<tr>
<td><?php echo $n++;?></td>
<td><?php echo $row['title'];?></td>
<td><img src="admin/images/user/<?php echo $row['image'];?>" width="100"></td>
<td><?php echo $row['new'];?></td>
<td><?php echo $value;?></td>
<td><?php echo $row['new']*$value;?></td>
<td>
...
<tr>
<td colspan="2"><a href="index1.php" class="btn btn-primary">Continue  Shopping <i class="fa fa-cart-plus"></i></a></td>
